...
Полное ТЗ, коды ошибок и критерии приёмки: [`docs/01-specification.md`](docs/01-specification.md). Контракт запросов: [`docs/03-api.md`](docs/03-api.md).
...
Текущий стек и эксплуатация: [`docs/04-stack.md`](docs/04-stack.md).
...
Команда использует отдельный временный Compose-контур и удаляет его вместе с
тестовыми данными после завершения.
